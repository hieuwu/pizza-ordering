import {SET_CATEGORYDATA, SET_USERTOKEN, ADD_TOCART, DELETE_ORDERLINE, MODIFY_ORDERLINE, RESET_ORDERLINEARRAY} from './../actions.js';
import {setCategoryData, setUserToken, addToCart, deleteOrderLine, modifyOrderLine, resetOrderLineArray} from './../actions.js';
...
describe('actions', () => {
  ...
  it('should create an action to modify order line', () => {
    ...
    expect(modifyOrderLine(orderLine, modifiedOrderLineIndex)).toEqual(expectedAction)
  })
