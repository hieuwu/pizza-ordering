...
describe('category screen test without user log in', () => {
    ...
    it('should show category images', () => {
        ...
        expect(pizzaImage.prop('source')).toEqual({'uri': initState.categoryData[0].imageUrl})
        expect(pastaImage.prop('source')).toEqual({'uri': initState.categoryData[1].imageUrl})
    })
